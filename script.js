...
function startEvilBlinking() {
  ...
  blinkTimeout = setTimeout(() => {
    ...
    mainText.innerHTML = "Happy Mother's Day";
    ...
    blinkTimeout = setTimeout(() => {
      ...
      mainText.innerHTML = "Mummy, aapka favourite baccha kon hai? 💘";
      mainText.classList.add("blink");
...
yesBtn.addEventListener("click", () => {
  ...
  message.innerHTML = "YES! YAYYY 💖 I knew it, Mummy 😍 I am your favourite child 💖";
...
noBtn.addEventListener("click", () => {
  ...
  setTimeout(() => {
    noBtn.innerText = "Mere chaaro bacche ❌";
  }, 1000);
});
